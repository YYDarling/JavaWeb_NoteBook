...
![点击查看源网页](https://s2.loli.net/2023/03/06/OzVfNkSKEwWXQZg.jpg)
...
![img](https://s2.loli.net/2023/03/06/suWdXzpMiqEmgJo.png)
...
<!-- 那么现在我们可以看到，实际上生效的是我们直接编写在标签内部的内联属性，那么现在我们依次进行移除，来看看它们的优先级。style 为最先显示“蓝色”（内连样式）--> red, #表示I --> yellow, 类选择器（class,.test）--> coloragl --> palegreen. -->
...
![DOM HTML 树](https://s2.loli.net/2023/03/06/JGkodEb31PMQ64A.gif)
